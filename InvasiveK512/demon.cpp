		...
		do{
			...
			if(cell_type == 0) {				
				...
				// cell migration or deme fission:
					...
					if(migration_type == 1) {
                        cell_migration(event_counter, parent_deme_num, &idum, &num_demes, &num_clones, chosen_clone, &num_cells, parent_geno_num, parent_driver_geno_num, &num_empty_demes, 
                        ...
                        deme_fission(event_counter, parent_deme_num, &idum, &num_demes, &num_clones, &num_cells, &num_empty_demes, 
